...
var (
	// this regular expression pattern is taken from
...
// Returns true if a specific value is in the list of strings
...
// Returns true if all strings values in a slice are unique
